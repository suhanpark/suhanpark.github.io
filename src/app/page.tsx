...
import { FaEnvelope, FaFilePdf, FaRegCalendarAlt } from "react-icons/fa";
    ...
    <>
      ...
      <div className=" flex flex-col items-center p-8 sm:p-20 text-gray-100">
        ...
        <section className="w-full  3xl:min-h-[80rem] max-w-2xl justify-center content-center ">
          ...
          <h1>
          <TypingEffect words={[' Suhan',' an Engineer', ' a Researcher', ' an AI Zealot', ' a Roboticist', ' a Visionary', ' an Innovator']} typingSpeed={130} blinkSpeed={500} />
          </h1>
          <br/>
        ...
        <footer className="mt-20 text-sm text-gray-400">
          © Inpired by Gabi. Built by Suhan. All rights reserved.
        </footer>
      </div>
    </>
  );
